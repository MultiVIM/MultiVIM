...
static const struct {
  unsigned short vk, fltk;
    ...
    {AKEYCODE_GRAVE, '`'},
    {AKEYCODE_VOLUME_DOWN, FL_Volume_Down},
    {AKEYCODE_MUTE, FL_Volume_Mute},
    {AKEYCODE_VOLUME_UP, FL_Volume_Up},
#if 0
#define FL_Volume_Down 0xEF11 /* Volume control down        */
        ...
        528
#endif
    {AKEYCODE_DEL, FL_BackSpace},
    {AKEYCODE_TAB, FL_Tab},
    {AKEYCODE_POUND, FL_Iso_Key},
    {AKEYCODE_ENTER, FL_Enter},
    /*{ 0x7F, FL_Pause },
{ 0x7F, FL_Scroll_Lock },*/
    {AKEYCODE_ESCAPE, FL_Escape},
    {AKEYCODE_KANA, FL_Kana},
    {AKEYCODE_EISU, FL_Eisu},
    {AKEYCODE_YEN, FL_Yen}, /*{ AKEYCODE_UND, FL_JIS_Underscore},*/
    {AKEYCODE_MOVE_HOME, FL_Home},
    {AKEYCODE_DPAD_LEFT, FL_Left},
    {AKEYCODE_DPAD_UP, FL_Up},
    {AKEYCODE_DPAD_RIGHT, FL_Right},
    {AKEYCODE_DPAD_DOWN, FL_Down},
    {AKEYCODE_PAGE_UP, FL_Page_Up},
    {AKEYCODE_PAGE_DOWN, FL_Page_Down},
    {AKEYCODE_MOVE_END, FL_End},
    {AKEYCODE_SYSRQ, FL_Print},
    {AKEYCODE_INSERT, FL_Insert},
    {AKEYCODE_MENU, FL_Menu},
    {AKEYCODE_HELP, FL_Help},
    {AKEYCODE_NUM_LOCK, FL_Num_Lock},
    {AKEYCODE_NUMPAD_ENTER, FL_KP_Enter},
    {AKEYCODE_NUMPAD_MULTIPLY, FL_KP + '*'},
    {AKEYCODE_NUMPAD_ADD, FL_KP + '+'},
    {AKEYCODE_NUMPAD_COMMA, FL_KP + ','},
    {AKEYCODE_NUMPAD_SUBTRACT, FL_KP + '-'},
    {AKEYCODE_NUMPAD_DOT, FL_KP + '.'},
    {AKEYCODE_NUMPAD_DIVIDE, FL_KP + '/'},
    {AKEYCODE_NUMPAD_0, FL_KP + '0'},
    {AKEYCODE_NUMPAD_1, FL_KP + '1'},
    {AKEYCODE_NUMPAD_2, FL_KP + '2'},
    {AKEYCODE_NUMPAD_3, FL_KP + '3'},
    {AKEYCODE_NUMPAD_4, FL_KP + '4'},
    {AKEYCODE_NUMPAD_5, FL_KP + '5'},
    {AKEYCODE_NUMPAD_6, FL_KP + '6'},
    {AKEYCODE_NUMPAD_7, FL_KP + '7'},
    {AKEYCODE_NUMPAD_8, FL_KP + '8'},
    {AKEYCODE_NUMPAD_9, FL_KP + '9'},
    {AKEYCODE_NUMPAD_EQUALS, FL_KP + '='},
    {AKEYCODE_F1, FL_F + 1},
    {AKEYCODE_F2, FL_F + 2},
    {AKEYCODE_F3, FL_F + 3},
    {AKEYCODE_F4, FL_F + 4},
    ...
    {AKEYCODE_F8, FL_F + 8},
    {AKEYCODE_F9, FL_F + 9},
    {AKEYCODE_F10, FL_F + 10},
    {AKEYCODE_F11, FL_F + 11},
    {AKEYCODE_F12, FL_F + 12},
    ...
    {AKEYCODE_SHIFT_LEFT, FL_Shift_L},
    {AKEYCODE_SHIFT_RIGHT, FL_Shift_R},
    {AKEYCODE_CTRL_LEFT, FL_Control_L},
    {AKEYCODE_CTRL_RIGHT, FL_Control_R},
    {AKEYCODE_CAPS_LOCK, FL_Caps_Lock},
    {AKEYCODE_META_LEFT, FL_Meta_L},
    {AKEYCODE_META_RIGHT, FL_Meta_R},
    {AKEYCODE_ALT_LEFT, FL_Alt_L},
    {AKEYCODE_ALT_RIGHT, FL_Alt_R},
    {AKEYCODE_FORWARD_DEL, FL_Delete}};
...
static int android_to_fltk_modifiers(int a) {
  ...
  if (a & AMETA_META_ON)
    fl_mod |= FL_META;
  if (a & AMETA_NUM_LOCK_ON)
    fl_mod |= FL_NUM_LOCK;
  if (a & AMETA_CAPS_LOCK_ON)
    fl_mod |= FL_CAPS_LOCK;
  if (a & AMETA_SCROLL_LOCK_ON)
    fl_mod |= FL_SCROLL_LOCK;
  // AMETA_SYM_ON
  // AMETA_FUNCTION_ON
...
int Fl_Android_Screen_Driver::handle_keyboard_event(AInputQueue *queue, AInputEvent *event) {
  ...
  int32_t 	AKeyEvent_getFlags (const AInputEvent *key_event)
   {
    AKEY_EVENT_FLAG_WOKE_HERE = 0x1, AKEY_EVENT_FLAG_SOFT_KEYBOARD = 0x2, AKEY_EVENT_FLAG_KEEP_TOUCH_MODE = 0x4,
  AKEY_EVENT_FLAG_FROM_SYSTEM = 0x8, AKEY_EVENT_FLAG_EDITOR_ACTION = 0x10, AKEY_EVENT_FLAG_CANCELED = 0x20,
  AKEY_EVENT_FLAG_VIRTUAL_HARD_KEY = 0x40, AKEY_EVENT_FLAG_LONG_PRESS = 0x80, AKEY_EVENT_FLAG_CANCELED_LONG_PRESS =
  ...
  */
  ...
  if (java.is_attached()) {
    ...
    jmethodID eventConstructor = java.env()->GetMethodID(class_key_event, "<init>", "(JJIIIIIIII)V");

    jobject eventObj =
        java.env()->NewObject(class_key_event, eventConstructor, AKeyEvent_getDownTime(event),
                              AKeyEvent_getEventTime(event), AKeyEvent_getAction(event), aKeyCode,
                              AKeyEvent_getRepeatCount(event), aMetaState, AInputEvent_getDeviceId(event),
    ...
    unicodeKey = java.env()->CallIntMethod(eventObj, method_get_unicode_char, AKeyEvent_getMetaState(event));
...
void Fl_Android_Screen_Driver::request_keyboard(/*o->rect(), o->type()*/) {
  if (pKeyboardCount == 0) {
    ...
    if (java.is_attached()) {
      ...
      jclass ClassScope = java.env()->FindClass("android/content/Context");
      jfieldID FieldINPUT_METHOD_SERVICE =
          java.env()->GetStaticFieldID(ClassScope, "INPUT_METHOD_SERVICE", "Ljava/lang/String;");
      jobject INPUT_METHOD_SERVICE = java.env()->GetStaticObjectField(ClassScope, FieldINPUT_METHOD_SERVICE);

      // Runs getSystemService(Context.INPUT_METHOD_SERVICE).
      jclass ClassInputMethodManager = java.env()->FindClass("android/view/inputmethod/InputMethodManager");
      jmethodID MethodGetSystemService = java.env()->GetMethodID(java.native_activity_class(), "getSystemService",
                                                                 "(Ljava/lang/String;)Ljava/lang/Object;");
      jobject lInputMethodManager =
          java.env()->CallObjectMethod(java.native_ativity(), MethodGetSystemService, INPUT_METHOD_SERVICE);

      // Runs getWindow().getDecorView().
      jmethodID MethodGetWindow =
          java.env()->GetMethodID(java.native_activity_class(), "getWindow", "()Landroid/view/Window;");
      jobject lWindow = java.env()->CallObjectMethod(java.native_ativity(), MethodGetWindow);
      jclass ClassWindow = java.env()->FindClass("android/view/Window");
      jmethodID MethodGetDecorView = java.env()->GetMethodID(ClassWindow, "getDecorView", "()Landroid/view/View;");
      jobject lDecorView = java.env()->CallObjectMethod(lWindow, MethodGetDecorView);

      // Runs lInputMethodManager.showSoftInput(...).
      jmethodID MethodShowSoftInput =
          java.env()->GetMethodID(ClassInputMethodManager, "showSoftInput", "(Landroid/view/View;I)Z");
      jboolean lResult = java.env()->CallBooleanMethod(lInputMethodManager, MethodShowSoftInput, lDecorView, lFlags);

      java.env()->DeleteLocalRef(ClassScope);
...
void Fl_Android_Screen_Driver::release_keyboard() {
  pKeyboardCount--;
  if (pKeyboardCount == 0) {
    ANativeActivity_hideSoftInput(Fl_Android_Application::get_activity(), ANATIVEACTIVITY_HIDE_SOFT_INPUT_NOT_ALWAYS);
  }
}
